...
- **學歷**：中原大學 資訊工程學系 (Chung Yuan Christian University, Taiwan. Information and Computer Engineering)
- **專長**：研究 Android 系統已有 8 年時間，專注於 Android 系統、AOSP、BSP 編譯、GKI Kernel、Recovery 開發以及開源軟體繁體中文化。

---

## 聯絡與社群連結

- [<i class="fab fa-github"></i> GitHub](https://github.com/bluehomewu)
- [<i class="fab fa-linkedin"></i> LinkedIn](https://www.linkedin.com/in/edward-wu-56765a251)
- [<i class="fab fa-instagram"></i> Instagram](https://www.instagram.com/_920223/)
- [<i class="fab fa-twitter"></i> Twitter / X](https://twitter.com/EdwardWu0231291)
- [<i class="fas fa-code"></i> HackMD](https://hackmd.io/@EdwardWu)
- [<i class="fas fa-globe"></i> Mobile01](https://www.mobile01.com/userinfo.php?id=3300121)
...
- **OmniVision 台灣豪威科技有限公司** Test Integration Engineering Intern

### 曾任
- **Google Developer Student Clubs (GDSC) @ CYCU** '23-'24 Lead
- **Intel Taiwan** 2nd Campus Ambassador
...
- **COSCUP 2025** 議程講者 
  - [《GKI Kernel: 終結 Android Kernel 的碎片化時代》](https://coscup.org/)
- **Google GDG Devfest Taipei 2025** 議程講者 
  - [《過去一年我在 AOSP 學了什麼：GKI, BSP, Hack Pixel Watch 2》](https://gdg.community.dev/events/details/google-gdg-taipei-presents-devfest-taipei-2025/)
- **SITCON 2021** 開放式議程講者 
  - [《從零開始編譯 Android 第三方系統！》](https://sitcon.org/2021/agenda/1c9e74cd-aeeb-4e63-8ec4-af33eff16e7d)
